...
JNIEXPORT void JNICALL Java_jp_androidgroup_nyartoolkit_NyARToolkitAndroidActivity_decodeYUV420SP(JNIEnv * env, jobject obj, jintArray rgb, jbyteArray yuv420sp, jint width, jint height, jint type)
{
    void *in, *out;
    int psz = getpagesize();
    int header_size;
